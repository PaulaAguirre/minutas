...
<head>
    ...
    <title>CASH FLOW | DELTAnet </title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url ('index_exp')}}" class="logo">
            ...
            <span class="logo-lg"><b>Cash Flow</b></span>
        </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href=""><i class="fa fa-book"></i>OTs</a></li>
                        <li><a href=""><i class="fa fa-book"></i> Gerencias</a></li>
                        <li><a href=""><i class="fa fa-book"></i> Departamentos</a></li>
                        <li><a href=""><i class="fa fa-book"></i> Funcionarios</a></li>
                        <li><a href=""><i class="fa fa-book"></i> Proveedores</a></li>
                        <li><a href=""><i class="fa fa-book"></i> Tipos de Expedientes</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('expedientes')}}"><i class="fa fa-folder"></i>Expedientes Creados</a></li>
                            <li><a href=""><i class="fa fa-folder"></i>Historial de Expedientes</a></li>
                    </ul>
                </li>
